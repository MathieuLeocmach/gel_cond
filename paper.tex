...
We use a novel experimental setup that allows the observation of the entire process of gelation at a single particle level (see Methods). The principle is to introduce salts through a membrane in a charged colloids and non adsorbing polymers suspension (see Fig.~\ref{fig:methods}a). The polymers induce a very short range depletion attraction between colloids, however long range electrostatic repulsion between the colloids prevent any aggregation. When we introduce salt the charges get screened and attraction suddenly kicks in, eventually leading to the formation of a gel. The whole process can take place on the microscope stage and can thus be observed in three dimensions from the very beginning.
