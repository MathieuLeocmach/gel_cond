...
To access roles of mechanics in the late stage, we realize a density matching of the order of 10$^{-4}$ (gravitational Peclet number $Pe< 10^{-7}$) and use a very accurate particle tracking method \cite{leocmach2013novel}. 
