...
Elastic ($G^\prime$) and viscous ($G^{\prime\prime}$) shear moduli at high frequency ($f=0.1\tau_\mathrm{B}^{-1}$), obtained by two-particle microrheology, are drawn respectively as red filled and black open circles. 
